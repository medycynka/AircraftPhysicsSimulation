...
{
    [CreateAssetMenu(fileName = "AircraftPhysicsDisplaySettings",
        menuName = "Aerodynamics/AircraftPhysicsDisplaySettings")]
    public class AircraftPhysicsDisplaySettings : ScriptableObject
    {
        private static AircraftPhysicsDisplaySettings _displaySettings;
        ...
        public static AircraftPhysicsDisplaySettings Load()
        {
            ...
            {
                Debug.LogWarning(
                    "Could not find AircraftPhysicsDisplaySettings asset. Will use default settings instead.");
